...
define('tittleTableTipoMerma', 'Lista de Tipos de Pagos');
define('tittleTableProducto', 'Lista de Deudores');
define('tittleTableStock', 'Lista de Stock');
define('tittleTableMerma', 'Lista de Pagos');
...
// Tipo Merma
define('tittleTipoMerma', 'Control de Tipos de Pago');
define('formTittleTipoMerma1', 'Nuevo Tipo de Pago');
define('formTittleTipoMerma2', 'Editar Tipo');
define('nombreTipoMerma', 'Nombre Tipo');
// Tipo Merma Alerts
define('tipoMermaRegistrado', 'Tipo de Pago Registrado Exitosamente');
define('tipoMermaEditado', 'Tipo de Pago Editado Exitosamente');
define('tipoMermaEliminado', 'Tipo de Pago Eliminado Exitosamente');
...
define('precioProducto', 'Restante Prestamo');
define('precioProductoTotal', 'Prestamo (Precio Total)');
