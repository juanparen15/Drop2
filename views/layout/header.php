...
<head>
  <link rel="shortcut icon" href="./assets/img/logo-DRB.ico" type="image/ico" />
  <link rel="shortcut icon" href="../assets/img/logo-DRB.ico" type="image/ico" />
  <meta charset="UTF-8">
  ...
  <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootswatch/4.3.1/<?= theme ?>/bootstrap.min.css">
