          ...
          <div class="container">
            <div class="row">
              <div class="col-md-9 col-lg-8 mx-auto">
                <?php if (theme == 'cyborg') : ?>
                  <h3 class="login-heading mb-4" style="color: black;"><?= titulo; ?></h3>
                <?php endif; ?>
                <?php if (theme == 'lumen') : ?>
                ...
                <div class="custom-control custom-checkbox mb-3">
                  ...
                  <button type="submit" class="btn btn-outline-info btn-block" style="color: black"><i class="fas fa-person-booth"></i> <?= btnIngresar; ?></button>
                </form>
                <div class="btn btn-outline-info btn-block  shadow" role="alert">
                  <a href="<?= baseUrl; ?>usuario/olvidoPass" style="color: black; text-decoration:none;"><?= btnOlvidoPass; ?></a>
                </div>
              </div>
            </div>
          </div>
