...
<body class="animated fadeIn faster">
  ...
  <div class="container">
    <p class="titulo">Control de Comprobantes</p>
    ...
    <form action="<?= baseUrl; ?>archivo/registrar" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="form-label-group col-12 col-lg-6 py-2">
          <label for="descripcion">Descripción del Comprobante <span class="maxN"></span></label>
    ...
    <table class="table table-bordered table-responsive-md table-hover" id="tabla">
      <caption class="text-center">Lista De Comprobantes</caption>
          ...
          <tr>
            ...
            <td><?= $doc->created_at; ?></td>
              ...
              <td class="d-flex justify-content-around border border-light">
                ...
                <!-- Agregar el botón de descarga aquí -->
                <a href="<?= baseUrl; ?>archivo/descargar&id=<?= $doc->document; ?>" class="btn btn-outline-success btn-sm <?= $doc->idUser == $_SESSION['identity']->idusuarios ? '' : 'disabled' ?>"><i class="fas fa-download"></i> <?= descargar ?></a>
              </td>
